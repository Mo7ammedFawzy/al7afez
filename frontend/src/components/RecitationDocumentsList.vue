        ...
        <tr v-for="recitation in items" :key="recitation.id">
          ...
          <td>
            <div class="button-row">
              <button class="secondary" type="button" @click="handleEdit(recitation)">{{ $t("common.edit") }}</button>
              <button class="danger" type="button" @click="handleRemove(recitation)">{{ $t("common.delete") }}</button>
            </div>
          </td>
        </tr>
      </tbody>
